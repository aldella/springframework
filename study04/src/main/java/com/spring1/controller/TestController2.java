...
public class TestController2 {
	...
	public String get4(@PathVariable("num") int num, @PathVariable("title") String title, Model model) {
		Sample samplesa = new Sample(num, title, "2020-2020202");
		model.addAttribute("samplesa",samplesa);
		return "test2/get4";
	}
	...
	public String post2(Sample sample, Model model) {
		model.addAttribute("samp", sample);
		return "test2/post2";
	}
	
	@PostMapping("post3.do")
	public String post3(@ModelAttribute("sam") Sample sample, Model model) {
		return "test2/post3";
	}
	
	@GetMapping("post4.do/{num}/{title}")
	public String post4(@PathVariable("num") int num, @PathVariable("title") String title, Model model) {
		Sample samplesal = new Sample(num, title, "2020-2020202");
		model.addAttribute("samplesal",samplesal);
		return "test2/post4";
	}
