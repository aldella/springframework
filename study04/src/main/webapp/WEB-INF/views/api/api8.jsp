...
<body>
	<h1>Classroom클래스입력</h1>
	<div class="form-team">
		<input type="text" name="part" id="part" placeholder="팀 이름" /><br>
		<input type="number" name="classnum" id="classnum" placeholder="팀 번호" /><br>
	</div>
	<div class="form">
	...
	<script>
		$(document).ready(function() {
			$("#btn1").click( function() {
				...
				var cls = {
						part:$("#part").val(),
						classNum:parseInt($("#classnum").val()),
						students:stds
				};
